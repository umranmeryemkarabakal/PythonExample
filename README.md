...
- `03`: `re` ile metinde kelime arama
- `04`: faktöriyel
- `05`: OpenCV ile görüntüde kırmızı bölge bulma (`red_point.png`)
- `06`: pandas + seaborn ile boy/kilo grafiği
- `07`: iki listenin küme işlemleri
- `08`: metin dosyasında kelime sayma (`girdi.txt` → `cikti.txt`)
- `09`: merge sort
